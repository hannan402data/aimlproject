...
class RecogniseFaceOrderFood(ctk.CTk):
    ...
    def greet_user(self, consent, user_name, user_id):
        ...
        profile_label = ctk.CTkLabel(self.main_frame, text="Customer Profile", font=("Helvetica", 24, "bold"), pady=10)
        ...
        if consent == 1:
            ...
            previous_orders_label = ctk.CTkLabel(self.main_frame, text="Your Previous Orders:", font=("Helvetica", 16, "bold"))  
            previous_orders_label.place(relx=0.85, rely=0.5, anchor="center")
            recommendation_text = "Recommendations:"
            recommended_orders_label = ctk.CTkLabel(self.main_frame, text=recommendation_text, font=("Helvetica", 16, "bold"))  
    ...
    def get_recommendations(self, user_id):  
        ...
        if food_name:  
            ...
            if recommended_foods:  
                ...
                CTkMessagebox(title="No Match", message="We couldn't find any similar dishes. \nIf order couldn't found in the list than check the menu again and sure what you are ordering or try refreshing the screen.")  
        else:  
